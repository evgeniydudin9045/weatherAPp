...
class MainActivity : AppCompatActivity() {
    ...
    val api: String = "1935d4c2d6a91c5ed49041fe8dad364d"
    ...
    inner class weatherTask(): AsyncTask<String, Void, String>() {
        ...
        override fun doInBackground(vararg params: String?): String? {
            var response: String?
            try {
                response = URL("http://api.openweathermap.org/data/2.5/weather?q=$city&appid=$api&units=metric")
        ...
        override fun onPostExecute(result: String?) {
            ...
            try {
                ...
                val updatedAtText = "Обновлено в: " + SimpleDateFormat(
                    "dd/MM/yyyy hh:mm a",
                    Locale.ENGLISH
                ).format(Date(updatedAt * 1000))
                val temp = main.getString("temp") + "\u2103"
                val tempMin = "Мин. темп: " + main.getString("temp_min") + "\u2103"
                val tempMax = "Макс. темп: " + main.getString("temp_max") + "\u2103"
